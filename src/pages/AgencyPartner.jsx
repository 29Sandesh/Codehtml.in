        ...
        {showAuthModal && (
          <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-[150] flex items-center justify-center p-4 overflow-y-auto">
            ...
            >
              ...
              {/* Toggle tabs inside modal (Hidden if showOtpScreen is active) */}
              {!showOtpScreen && (
                <div className="flex border-b border-white/5 pb-4 mb-6 gap-6">
                  <button
                    ...
                    className={`font-headline font-bold text-xs uppercase tracking-wider transition-colors ${
                      modalMode === 'signup'
                        ? 'text-vintage-gold border-b-2 border-vintage-gold pb-2 -mb-[18px]'
              ...
              {/* Notifications */}
              {successMsg && (
                <div className="mb-4 p-3.5 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-xl font-body text-xs text-center">
                  {successMsg}
                </div>
              )}
              {errorMsg && (
                <div className="mb-4 p-3.5 bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl font-body text-xs text-center">
                  {errorMsg}
                </div>
              )}
              ...
              {showOtpScreen ? (
                ...
                <form onSubmit={handleOTPVerify} className="space-y-4">
                  <div className="text-center mb-2">
                    <p className="font-body text-zinc-400 text-xs leading-relaxed">
                      We've sent a 6-digit OTP verification code to <strong className="text-white">{signupForm.email}</strong>. Please enter it below.
                    </p>
                  </div>
                  <div>
                    <label className="block font-body text-[9px] font-bold text-zinc-400 uppercase tracking-wider mb-1">Verification Code</label>
                    <input
                      type="text"
                      required
                      maxLength={6}
                      ...
                      className="w-full px-3.5 py-2.5 bg-zinc-900/40 border border-white/10 rounded-xl font-body text-center text-lg tracking-[0.5em] text-white focus:outline-none focus:border-vintage-gold/50 focus:bg-zinc-900/80 transition-colors font-mono"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl bg-vintage-gold hover:bg-white hover:text-black text-black font-body font-bold text-xs tracking-wider uppercase transition-all duration-300 inline-flex items-center justify-center gap-2 disabled:opacity-50"
                  >
                  ...
                  <div className="flex justify-between items-center pt-2">
                    <button
                      ...
                      className="text-[10px] font-body font-bold text-zinc-500 hover:text-white transition-colors cursor-pointer"
                    >
                      ← Back to Form
                    </button>
                    <button
                      ...
                      className="text-[10px] font-body font-bold text-vintage-gold hover:text-white transition-colors disabled:text-zinc-600 disabled:hover:text-zinc-600 cursor-pointer"
                    >
                ...
                /* SIGN UP STAGES */
                signupStep === 'choice' ? (
                  /* Step A: Partner Type Choice */
                  <div className="space-y-4">
                    <h3 className="font-headline font-black text-lg uppercase text-white mb-4">Sign Up As</h3>
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <button
                        ...
                        className="p-4 bg-zinc-900/40 hover:bg-zinc-900/80 border border-white/5 hover:border-vintage-gold/20 rounded-2xl flex items-center gap-4 cursor-pointer text-left transition-all group w-full"
                      >
                        <div className="w-10 h-10 rounded-xl bg-zinc-900 border border-white/10 flex items-center justify-center text-zinc-400 group-hover:bg-vintage-gold group-hover:text-black transition-all flex-shrink-0">
                          <Laptop className="w-5 h-5" />
                        </div>
                        <span className="font-headline font-bold text-sm uppercase text-white group-hover:text-vintage-gold transition-colors">Freelancer</span>
                      </button>
                      ...
                      <button
                        ...
                        className="p-4 bg-zinc-900/40 hover:bg-zinc-900/80 border border-white/5 hover:border-vintage-gold/20 rounded-2xl flex items-center gap-4 cursor-pointer text-left transition-all group w-full"
                      >
                        <div className="w-10 h-10 rounded-xl bg-vintage-gold/10 border border-vintage-gold/20 flex items-center justify-center text-vintage-gold group-hover:bg-vintage-gold group-hover:text-black transition-all flex-shrink-0">
                          <Layers className="w-5 h-5" />
                        </div>
                        <span className="font-headline font-bold text-sm uppercase text-white group-hover:text-vintage-gold transition-colors">Agency</span>
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      disabled={submitting}
                      className="w-full py-3 rounded-xl border border-white/10 hover:border-vintage-gold bg-zinc-950 hover:bg-zinc-900 text-white font-body font-bold text-xs tracking-wider uppercase transition-all duration-300 inline-flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                    >
                  ...
                  /* Step B: The Actual Form */
                  <form onSubmit={handleSignUp} className="space-y-4">
                    <div className="flex items-center justify-between pb-2 border-b border-white/5">
                      <span className="text-[10px] font-body font-bold text-vintage-gold uppercase tracking-wider">
                        {partnerType === 'agency' ? 'Agency Details' : 'Freelancer Details'}
                      </span>
                      <button
                        type="button"
                        onClick={() => setSignupStep('choice')}
                        className="text-[9px] font-body text-zinc-500 hover:text-white transition-colors cursor-pointer"
                      >
                        Change Tier
                      </button>
                    </div>
                    ...
                    <div>
                      <label className="block font-body text-[9px] font-bold text-zinc-400 uppercase tracking-wider mb-1">Full Name</label>
                      <input
                        type="text"
                        required
                        ...
                        className="w-full px-3.5 py-2.5 bg-zinc-900/40 border border-white/10 rounded-xl font-body text-xs text-white focus:outline-none focus:border-vintage-gold/50 focus:bg-zinc-900/80 transition-colors"
                      />
                    </div>
                    <div>
                      <label className="block font-body text-[9px] font-bold text-zinc-400 uppercase tracking-wider mb-1">Email Address</label>
                      <input
                        type="email"
                        required
                    ...
                    <div>
                      <label className="block font-body text-[9px] font-bold text-zinc-400 uppercase tracking-wider mb-1">Password</label>
                      <input
                        type="password"
                        required
                    ...
                    {partnerType === 'agency' && (
                      <div className="space-y-4 border-l border-vintage-gold/20 pl-3.5 my-3">
                        <div>
                          <label className="block font-body text-[9px] font-bold text-vintage-gold uppercase tracking-wider mb-1">Agency Name</label>
                          <input
                            type="text"
                            required={partnerType === 'agency'}
                            placeholder="e.g. Pixel Studio"
                            value={signupForm.agencyName}
                            onChange={(e) => setSignupForm({ ...signupForm, agencyName: e.target.value })}
                            className="w-full px-3.5 py-2.5 bg-zinc-900/40 border border-vintage-gold/20 rounded-xl font-body text-xs text-white focus:outline-none focus:border-vintage-gold/50 focus:bg-zinc-900/80 transition-colors"
                          />
                        </div>
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            <label className="block font-body text-[9px] font-bold text-zinc-400 uppercase tracking-wider mb-1">Agency Size</label>
                            <select
                              value={signupForm.agencySize}
                              onChange={(e) => setSignupForm({ ...signupForm, agencySize: e.target.value })}
                              className="w-full px-3.5 py-2.5 bg-zinc-900/40 border border-white/10 rounded-xl font-body text-xs text-white focus:outline-none focus:border-vintage-gold/50 focus:bg-zinc-900/80 transition-colors appearance-none"
                            >
                          ...
                          <div>
                            <label className="block font-body text-[9px] font-bold text-zinc-400 uppercase tracking-wider mb-1">Agency Website</label>
                            <input
                              type="url"
                              placeholder="e.g. https://pixelstudio.com"
                              value={signupForm.agencyWebsite}
                              onChange={(e) => setSignupForm({ ...signupForm, agencyWebsite: e.target.value })}
                              className="w-full px-3.5 py-2.5 bg-zinc-900/40 border border-white/10 rounded-xl font-body text-xs text-white focus:outline-none focus:border-vintage-gold/50 focus:bg-zinc-900/80 transition-colors"
                            />
                          </div>
                        </div>
                    ...
                    <div>
                      <label className="block font-body text-[9px] font-bold text-zinc-400 uppercase tracking-wider mb-1">Phone Number</label>
                      <input
                        type="tel"
                        required
                        placeholder="+91 93032..."
                    ...
                    <button
                      type="submit"
                      disabled={submitting}
                      className="w-full py-3 rounded-xl bg-vintage-gold hover:bg-white hover:text-black text-black font-body font-bold text-xs tracking-wider uppercase transition-all duration-300 inline-flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                ...
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 rounded-xl bg-vintage-gold hover:bg-white hover:text-black text-black font-body font-bold text-xs tracking-wider uppercase transition-all duration-300 inline-flex items-center justify-center gap-2"
                  >
                    Sign In to Console ➲
                  </button>
                  ...
                  <button
                    ...
                    onClick={handleGoogleLogin}
                    disabled={submitting}
                    className="w-full py-3.5 rounded-xl border border-white/10 hover:border-vintage-gold bg-zinc-950 hover:bg-zinc-900 text-white font-body font-bold text-xs tracking-wider uppercase transition-all duration-300 inline-flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                  >
                    <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24">
                      <path
                        fill="#4285F4"
