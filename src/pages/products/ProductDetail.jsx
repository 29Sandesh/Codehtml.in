...
import { CheckCircle2, ChevronDown, HelpCircle, Code, ShieldCheck, DollarSign, ArrowLeft } from 'lucide-react';
...
const ProductDetail = () => {
  ...
  return (
    <>
      <SEO 
        title={`${product.title} - Custom Software Products`}
        description={product.description}
      />
      <div className="min-h-screen bg-black text-white pt-28 pb-20 px-4 sm:px-12">
        <div className="max-w-[1600px] mx-auto">
          {/* Back Navigation */}
          <Link to="/products" className="inline-flex items-center gap-2 text-zinc-500 hover:text-vintage-gold text-xs font-body font-bold tracking-wider uppercase mb-8 transition-colors">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="mb-10">
                <h2 className="font-headline font-extrabold text-lg text-white uppercase tracking-wider mb-5 flex items-center gap-2">
                  <ShieldCheck className="w-5 h-5 text-vintage-gold" /> System Capabilities
                </h2>
              ...
              <div>
                <h2 className="font-headline font-extrabold text-lg text-white uppercase tracking-wider mb-4 flex items-center gap-2">
                  <Code className="w-5 h-5 text-vintage-gold" /> Tech Stack & Infrastructure
                </h2>
              ...
              >
                ...
                <div className="p-4 rounded-2xl bg-black/40 border border-white/5 mb-6">
                  ...
                  <div className="flex flex-col gap-1.5 mt-2 border-t border-white/5 pt-2">
                    {product.pricing.features.map((item, idx) => (
                ...
                <span className="text-[9px] font-body text-zinc-500 text-center block mt-3 leading-normal">
                  All contracts include 100% intellectual property ownership. Zero recurring license locks.
                </span>
              </motion.div>
            </div>
          </div>
