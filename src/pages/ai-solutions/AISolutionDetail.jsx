...
import { AI_SOLUTIONS_DATA } from '../../data/aiSolutionsData';
...
const AISolutionDetail = () => {
  ...
  return (
    <>
      <SEO 
        title={`${solution.title} - AI Solutions`}
        description={solution.description}
      />
      <div className="min-h-screen bg-black text-white pt-28 pb-20 px-4 sm:px-12">
        <div className="max-w-[1600px] mx-auto">
          {/* Back Navigation */}
          <Link to="/ai-solutions" className="inline-flex items-center gap-2 text-zinc-500 hover:text-vintage-gold text-xs font-body font-bold tracking-wider uppercase mb-8 transition-colors">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="mb-10">
                <h2 className="font-headline font-extrabold text-lg text-white uppercase tracking-wider mb-5 flex items-center gap-2">
                  <ShieldCheck className="w-5 h-5 text-vintage-gold" /> Automation Workflows
                </h2>
              ...
              <div>
                <h2 className="font-headline font-extrabold text-lg text-white uppercase tracking-wider mb-4 flex items-center gap-2">
                  <Code className="w-5 h-5 text-vintage-gold" /> Models & API Frameworks
                </h2>
              ...
              >
                ...
                <div className="flex items-baseline gap-1 mb-4">
                  <span className="font-headline font-extrabold text-3xl sm:text-4xl text-white">
                    {formatPrice(solution.pricing.price, currency)}
                  </span>
                </div>
                ...
                <span className="text-[9px] font-body text-zinc-500 text-center block mt-3 leading-normal">
                  Our custom AI setups run on client API accounts with direct billing, protecting your intellectual property.
                </span>
              </motion.div>
            </div>
          </div>
              ...
              <table className="w-full text-left border-collapse min-w-[500px]">
                ...
                <tbody className="divide-y divide-white/5 font-body text-xs sm:text-sm font-semibold">
                  ...
                  <tr>
                    ...
                    <td className="p-4 sm:p-5 text-vintage-gold bg-vintage-gold/5">AED 0 (Hosted on free Edge platforms)</td>
                    <td className="p-4 sm:p-5 text-zinc-500">AED 500+ (mandatory plugin license keys)</td>
                  </tr>
                  <tr>
