...
const AISolutionsIndex = () => {
  const [currency] = useCurrency();
  const categories = [
    {
      title: "Add AI to Your Profit",
      icon: Bot,
      slugs: ['ai-voice-chatbots', 'ai-consultancy', 'ai-search', 'ai-sales-agent']
    },
    {
      title: "Automate to Dominate",
      icon: Cpu,
      slugs: ['agents-and-processes', 'ai-customer-support-agent', 'revenue-automation', 'client-control', 'finance-and-structure']
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white pt-28 pb-20 px-4 sm:px-12">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            AI Solutions Built For <span className="text-vintage-gold">Growth</span>
          </motion.h1>
          <motion.p 
          ...
          >
            Deploy custom-trained AI agents and cloud process automation bots to handle support tickets, generate sales leads, and streamline corporate accounting.
          </motion.p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  {cat.slugs.map((slug) => {
                    const sol = AI_SOLUTIONS_DATA[slug];
                    if (!sol) return null;
                    return (
                      <Link
                        key={slug}
                        to={`/ai-solutions/${slug}`}
                      ...
                      >
                        ...
                        <div className="mt-4 pt-3 border-t border-white/5 flex justify-between items-center text-[10px]">
                          ...
                          <span className="font-headline font-bold text-vintage-gold">
                            {formatPrice(sol.pricing.price, currency)}
                          </span>
                        </div>
                      </Link>
                    );
...
export default AISolutionsIndex;
